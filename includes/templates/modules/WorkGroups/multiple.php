...
<?php $indexCount = 0; ?>
<div class="splide s3dm_workgroups_container" data-splide="<?= $this->e($slide_options); ?>">
    <div class="s3dm_workgroups_slider splide__track">
        <ul class="s3dm_workgroups_slider_items splide__list uk-child-width-1-1">
            <?php foreach ($workgroups as $group): ?>

                <li class="splide__slide s3dm_workgroups_slider_item uk-padding uk-padding-remove-left" switcher_index="<?= $indexCount; ?>">
