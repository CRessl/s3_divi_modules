...
class PostListGrid extends Component {
  ...
  renderPackshotTop(packshot, memberprice){
    ...
    if(memberprice === 0){
      ...
      return (
        ...
        <div className="bubble">
          ...
          <p>Für EHI-Mitglieder kostenlos</p>
  ...
  render() {
    ...
    postListItems = postData.map(({title, image, tags, packshot, excerpt, link, date, price, memberprice, format, subtitle, page}, index) => {

      return (
        <div className={containerClass} key={index}>
          <div className="uk-card-default">
            {this.renderImageTop(image)}
            {this.renderPackshotTop(packshot, memberprice)}
