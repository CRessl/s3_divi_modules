	...
	public function get_fields() {
        ...
        $fields = array(
            ...
            'current_category' => array(
				'label'             => esc_html__( 'Current Category', 'et_builder' ),
				'type'              => 'select',
                'options'           => $this->getCategorySlugList(),
				'option_category'   => 'basic_option',
				'description'       => esc_html__( 'Choose which category is currently displayed. Pleas choose only one', 'et_builder' ),
				'toggle_slug'       => 'connections',
                'defualt_on_front'  => 0,
			),
            'connections' => array(
                'label'            => esc_html__( 'Connect to Categories', 'et_builder' ),
				'type'             => 'categories',
				'option_category'  => 'basic_option',
				'renderer_options' => array(
					'use_terms' => false,
				),
				'description'      => esc_html__( 'Choose which to which category you would like to connect', 'et_builder' ),
				'toggle_slug'      => 'connections',
            ),
