...
function header_fact_finder(){
    ...
    <script src="<?= plugins_url('/assets/factfinder/dist/vendor/custom-elements-es5-adapter.js', dirname(__FILE__, 1)) ?>"></script>
    <script src="<?= plugins_url('/assets/factfinder/dist/vendor/webcomponents-loader.js',dirname(__FILE__, 1)) ?>"></script>
    <script defer src="<?= plugins_url('/assets/factfinder/dist/bundle.js', dirname(__FILE__, 1)) ?>"></script>
    <?php
    }; 
